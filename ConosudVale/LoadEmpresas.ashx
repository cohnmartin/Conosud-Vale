...
{
    public List<View_EmpresasContratos> DatosFiltrados
    {
        get
        {
            if (HttpContext.Current.Session["DatosEmpresa"] != null)

                return (List<View_EmpresasContratos>)Helper.DeSerializeObject(HttpContext.Current.Session["DatosEmpresa"], typeof(List<View_EmpresasContratos>));
            else
            {
                return null;
            }
        ...
        {
            if (value != null)
                HttpContext.Current.Session["DatosEmpresa"] = Helper.SerializeObject(value);
            else
                HttpContext.Current.Session["DatosEmpresa"] = value;
        }
    }
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            datosResult = (List<View_EmpresasContratos>)DatosFiltrados;
        }
