...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%">
        ...
        <tr >
            <td style="width: 318px">
                <asp:Label ID="Label2" runat="server" Text="2º Importación de Legajos:"></asp:Label>
            </td>
            <td>
       ...
       <tr >
            <td style="width: 318px">
                <asp:Label ID="Label1" runat="server" Text="3º Importación de Vehiculos:"></asp:Label>
            </td>
            <td>
                <asp:Button ID="btnVahiculos" runat="server" SkinID="btnConosud" OnClick="btnVehiculos_Click"
                    Text="Button" />
            </td>
            <td>
                &nbsp;
         ...
         <tr >
            <td style="width: 318px">
                <asp:Label ID="Label9" runat="server" Text="4º Importación de Vehiculos:"></asp:Label>
            </td>
            <td>
                <asp:Button ID="btnEquipos" runat="server" SkinID="btnConosud" OnClick="btnEquipos_Click"
                    Text="Button" />
            </td>
            <td>
                &nbsp;
