...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function BuscarDatos() {
            ...
            var patente = $find("<%= txtApellidoBusqueda.ClientID %>").get_value();
            PageMethods.GetData(patente, ($find("<%=GridIngresos.ClientID %>").get_pageSize() * $find("<%=GridIngresos.ClientID %>").get_currentPageIndex()), $find("<%=GridIngresos.ClientID %>").get_pageSize(), FillGrid, Error);
...
//            }
        ...
        function AplicarCambios() {
            ...
            if (Page_ClientValidate()) {
                ...
                $find("<%=txtFechaIngreso1.ClientID %>").clear();
                $find("<%=txtFechaSolicitud.ClientID %>").clear();
            ...
            <cc1:ServerControlWindow ID="ServerControlWindow1" runat="server" BackColor="WhiteSmoke"
                ...
                <ContentControls>
                    <cc1:ServerPanel runat="server" ID="pnlEdicion">
                        <BodyContent>
                            <div id="divPrincipal" style="height: 270px; width: 780px">
