<%@ Page Title="" Theme="MiTema" Language="C#" MasterPageFile="~/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="GestionPublicacion.aspx.cs" Inherits="GestionPublicacion" %>
    ...
    <table id="Table1" style="border-right: #843431 thin solid; border-top: #843431 thin solid;
        ...
        <tr>
            ...
            <td id="Td1" align="left" style="width: 55px; height: 26px">
                <telerik:RadNumericTextBox ID="txtMes" runat="server" MinValue="1" MaxValue="12" ShowSpinButtons="true"
                 NumberFormat-DecimalDigits="0" Skin="Sunset" Width="50px" style="text-align:center">
            ...
            <td id="Td2" align="left" style="width: 95px; height: 26px">
                <telerik:RadNumericTextBox ID="txtAño" runat="server" MinValue="2000" MaxValue="2050" ShowSpinButtons="true"
                 NumberFormat-DecimalDigits="0" Skin="Sunset" Width="75px" style="text-align:center" NumberFormat-GroupSeparator="" 
                 MaxLength="4">
                </telerik:RadNumericTextBox>
            </td>
            ...
            <td valign="middle" align="left">
                <asp:Button ID="btnBuscar" runat="server" CommandName="Buscar" SkinID="btnConosudBasic"
                    Text="Buscar"  Mensaje="Buscando hojas de ruta..." 
        ...
        <ContentTemplate>
            <table style="border-right: #843431 thin solid; border-top: #843431 thin solid; border-left: #843431 thin solid;
                ...
                <tr id="trReporte" runat="server">
                    <td align="center" valign="top">
                       ...
                       <telerik:RadGrid ID="gvCabeceras" runat="server" Skin="Sunset" AutoGenerateColumns="False"
                            ...
                            <MasterTableView   ClientDataKeyNames="IdCabeceraHojasDeRuta" 
                                                DataKeyNames="IdCabeceraHojasDeRuta" TableLayout="Fixed" ShowFooter="true"   >
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="EsContratista" 
                                        HeaderText="EsConrtatista" UniqueName="EsContratista" Visible="false">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Gral" UniqueName="ImagenAprobacionColumn">
                                                    <ItemTemplate>
                                                        <asp:Image ImageUrl="~/Images/ListaParaPublicar.gif" ID="imgAprobacion" runat="server"
                                                            Style="cursor: hand;" ToolTip="Hoja apta para ser publicada" />
                                                    </ItemTemplate>
                                    ...
                                    <telerik:GridBoundColumn DataField="ContratoCodigo" SortedBackColor="ActiveBorder" ShowSortIcon="true" HeaderText="Codigo" UniqueName="Codigo">
                                        <ItemStyle HorizontalAlign="Center" />
                                         <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ConstratistaParaSubConstratista" HeaderText="Contratista" UniqueName="Contratista">
                                    ...
                                    <telerik:GridBoundColumn DataField="EstadoDescripcion" HeaderText="Estado" UniqueName="Estado" EmptyDataText="No Aprobada">
                                    ...
                                    <telerik:GridBoundColumn DataField="Publicada" HeaderText="Publicada"
                                        UniqueName="publicadaColumn">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
                ...
                <tr id="tr1" runat="server">
                    <td align="center" valign="top">
                        <asp:Button ID="btnPublicar" runat="server"  SkinID="btnConosudBasic"
                            Text="Guardar" Mensaje="Publicando Hojas de Ruta..." onclick="btnPublicar_Click" />
                    </td>
                </tr>
                <tr id="trResultadoVacio" runat="server" visible="false">
                    <td align="center" valign="top">
                        <asp:Label ID="Label3" runat="server"  Font-Size="13pt" Font-Names="Sans-Serif"
                            ForeColor="white" Text="No existen hojas con documentación recibida en el período seleccionado, que puedan ser publicadas" Width="468px"></asp:Label>
                    </td>
                </tr>
            </table>
        </ContentTemplate>
