        ...
        using (EntidadesConosud dc = new EntidadesConosud())
        {
            ...
            if (EsHistorico)
            {
                ...
                HRConPendientes = (from I in dc.HojasDeRuta
                                   ...
                                   && (I.CabeceraHojasDeRuta.Periodo <= cabecera.Periodo || (I.CabeceraHojasDeRuta.Periodo.Year == cabecera.Periodo.Year && I.CabeceraHojasDeRuta.Periodo.Month == cabecera.Periodo.Month))
