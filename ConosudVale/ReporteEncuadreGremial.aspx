<%@ Page EnableEventValidation="false" Theme="MiTema"   Title="Reporte Encuadre Gremial" Language="C#" MasterPageFile="~/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="ReporteEncuadreGremial.aspx.cs" Inherits="ReporteEncuadreGremial" %>
        ...
        <tr>
            <td align="center" style="height: 25px; background: url('images/sprite.gif') 0  -997px repeat-x">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="14pt" Font-Names="Sans-Serif"
                    ForeColor="#E0D6BE" Text="Reporte Encuadre Gremial" 
        ...
        <tr>
            ...
            <td valign="middle" align="left">
                <asp:Button ID="btnBuscar" runat="server" CommandName="Generar" SkinID="btnConosudBasic"
                    Text="Buscar" Mensaje="Generando informe de encuadre gremial..." OnClick="btnBuscar_Click" />
            </td>
        </tr>
    </table>
