...
public partial class ReporteEquiposAfectados : System.Web.UI.Page
{
    ...
    void GridRecursosAfectados_ExportToExcel(object sender)
    {
        ...
        DatosReporte.Add("Listado de Equipos afectados por Empresa");
        ...
        DatosReporte.Add("Incluye a todos los equipos afectados a contratos vigentes del per&iacute;odo de consulta");
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=EquiposAfectados" + "_" + DateTime.Now.ToString("M_dd_yyyy_H_M_s") + ".xls");
