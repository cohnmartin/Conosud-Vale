        ...
        <asp:UpdatePanel ID="UpdPnlGrilla" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <telerik:RadGrid ID="grillaRoles" runat="server" AllowPaging="True" AllowSorting="True"
                    ShowStatusBar="True" GridLines="None" Skin="Sunset" PageSize="10" Width="70%"
                    AllowAutomaticDeletes="false" AllowAutomaticInserts="false" AllowAutomaticUpdates="false"
                    AutoGenerateColumns="False" OnDataBound="grillaRoles_DataBound" OnNeedDataSource="grillaRoles_NeedDataSource"
                    OnItemCommand="grillaRoles_ItemCommand" OnSelectedIndexChanged="grillaRoles_SelectedIndexChanged"
                    OnItemDataBound="grillaRoles_ItemDataBound">
                    <MasterTableView DataKeyNames="IdSegRol" ClientDataKeyNames="IdSegRol" TableLayout="Fixed"
                        CommandItemDisplay="Top" EditMode="PopUp" NoMasterRecordsText="No existen registros."
                        HorizontalAlign="NotSet">
                        <CommandItemTemplate>
                            <div style="padding: 5px 5px;">
                                <asp:LinkButton Mensaje="Buscando Rol...." ID="btnEdit" runat="server" CommandName="EditSelected"
                                    Visible='<%# grillaRoles.EditIndexes.Count == 0 %>'>
                                <img style="padding-right: 5px;border:0px;vertical-align:middle;" alt="" src="Images/Edit.gif" />Editar</asp:LinkButton>&nbsp;&nbsp;
                                <asp:LinkButton Mensaje="Preparando Para Nuevo Rol...." ID="btnInsert" runat="server"
                                    CommandName="InitInsert" Visible='<%# !grillaRoles.MasterTableView.IsItemInserted %>'>
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn DataField="Descripcion" HeaderText="Nombre del Rol" SortExpression="Descripcion"
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="LoginTextBox" runat="server" Text='<%# Bind("Descripcion") %>' Style="text-transform: uppercase"
