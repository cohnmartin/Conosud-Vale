...
public partial class ReporteAltaModificacionVehiculoEquipos : System.Web.UI.Page
{
    ...
    public List<AltaModificaionVehiculosEquipos> _VehiculosEquiposEncontrados
    {
        ...
        get
        {
            if (Session["VehiculosEquiposEncontrados"] != null)
                ...
                return (List<AltaModificaionVehiculosEquipos>)Helper.DeSerializeObject(Session["VehiculosEquiposEncontrados"], typeof(List<AltaModificaionVehiculosEquipos>));
            else
            {
                return (List<AltaModificaionVehiculosEquipos>)Helper.DeSerializeObject(Session["VehiculosEquiposEncontrados"], typeof(List<AltaModificaionVehiculosEquipos>));
            }
        ...
        set
        {
            Session["VehiculosEquiposEncontrados"] = Helper.SerializeObject(value);
        }
    }
    ...
    {
        GridAltaBajas.ExportToExcelFunction("AltaModificaionVehiculosEquipos", _VehiculosEquiposEncontrados);
    }
    ...
    public static object GetData(string periodo, int start, int take)
    {
        ...
        {
            HttpContext.Current.Session["VehiculosEquiposEncontrados"] = Helper.SerializeObject(VehiculosActuales.ToList()); 
        }
        else
        {
