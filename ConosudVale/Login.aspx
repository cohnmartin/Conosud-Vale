...
<html>
<head runat="server">
    <title>Gestión Auditoria Conosud</title>
    ...
    <script type="text/javascript">
        ...
        function setRelacionEmpresa() {

            var emp = document.getElementById("query").value;
            if (emp != "")
                options = { serviceUrl: 'LoadEmpresas.ashx', width: '484', showInit: true, minChars: 0, params: { Tipo: 'C', Empresa: emp} };
            else
                options = { serviceUrl: 'LoadEmpresas.ashx', width: '484', showInit: false, minChars: 0, params: { Tipo: 'C', Empresa: emp} };

            a = $('#queryContrato').autocomplete(options);
...
<body style="margin: 0;background-color: #E4E4E4; margin-top: 2px; ">
    <form id="form1" runat="server">
    <div style="margin:0px;padding:0px;text-align:center" >
        <table cellpadding="0" cellspacing="0" style="width: 980px">
            <tr>
                <td align="center" style="border: solid 1px black; background: transparent url('images/rotulo_new.jpg') no-repeat;
                    height: 109px;">
                    &nbsp;
                </td>
            </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color: Transparent;">
                        <tr>
                            <td style="width: 27px; height: 44px; background-repeat: no-repeat; background-color: Transparent;
                                ...
                                <div style="width: 100%; background-color: #EEEEEE; position: relative; left: 15px;
                                    top: 15px; z-index: -1">
                                </div>
                            </td>
                            <td style="width: 350px; background-repeat: repeat-x; background-color: Transparent;
                                ...
                                <div style="width: 100%; height: 15px; background-color: #EEEEEE; position: relative;
                                    top: 35px; z-index: -1">
                                </div>
                                <asp:Label runat="server" ID="lblCabec" Style="color: White; font-size: 16px; font-family: Viner Hand ITC;
                                    font-weight: bold; text-align: left; top: -10px; position: relative; left: -15px;
                                    z-index: 1000" Text="">Acceso Usuarios Conosud</asp:Label>
                            </td>
                            <td style="width: 27px; background-repeat: no-repeat; background-color: Transparent;
                                ...
                                <div style="width: 100%; background-color: #EEEEEE; position: relative; left: -10px;
                                    top: 25px; z-index: -1">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="background-repeat: repeat-y; background-color: Transparent; background-position: left top;
                                background-image: url('Images/ImagenesNewLogin/LoginConosud_r3_c1.png')">
                                <div style="height: 140px; background-color: #EEEEEE; position: relative; left: 10px;
                                    z-index: -1">
                                    &nbsp;
                                </div>
                            </td>
                            <td style="width: 350px; height: 140px;">
                                <table border="0" cellpadding="4" width="100%" cellspacing="0" style="height: 100%;
                                    font-family: Tahoma; background-color: #EEEEEE; font-size: 11px">
                                    <tr>
                                        <td align="right" style="color: Black;">
                                            <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">Nombre de Usuario:</asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="UserName" runat="server" Font-Size="12px" Width="150px" Height="15px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Password" runat="server" Font-Size="0.9em" TextMode="Password" Height="15px"
                            ...
                            <td style="height: 140px; background-repeat: repeat-y; background-color: Transparent;
                                ...
                                <div style="width: 100%; height: 100%; background-color: #EEEEEE; position: relative;
                        ...
                        <tr>
                            ...
                            <td align="left" style="padding-top: 15px; font-weight: bold; color: White; height: 37px;
                                ...
                                vertical-align: top">
                                <div style="width: 100%; background-color: #EEEEEE; position: relative; top: -15px;
                                    z-index: -1">
                                </div>
                            </td>
                            <td style="height: 37px; background-repeat: no-repeat; background-color: Transparent;
    ...
    <input id="query" type="text" style="width: 250px; display: none" />
    <input id="queryContrato" type="text" onfocus="setRelacionEmpresa();" style="width: 250px;
        display: none" />
    </form>
</body>
</html>
