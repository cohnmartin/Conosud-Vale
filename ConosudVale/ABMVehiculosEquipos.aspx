...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function FechaMinimaValida(datos, FechaVencimientoContrato) {
            ...
            if (fechaIngresada != undefined && fechaIngresada > fechaMinima)
                return fechaMinima.format("dd/MM/yyyy");
            else
                return null;
    ...
    <script type="text/javascript">
        ...
        function EditarVehiculo(sender, Id) {
            ...
            //            var fechaminima = $find("<%=GridVehiculos.ClientID %>").get_ItemDataByKey(Id).FechaMinima;
            //            if (fechaminima != undefined)
            //                $find("<%=txtFechaVenCredencial.ClientID %>").set_maxDate(fechaminima);
        ...
        function ShowNewCredencial(sender, id) {
            if (id != "") {
                ...
                var oWnd = radopen('ViewerCredenciales.aspx?IdVehiculoEquipo=' + id, 'RadWindow2');
            }
            else {
        ...
        function BuscarDatos() {
            ...
            var patente = $find("<%= txtNroPatente.ClientID %>").get_value();
            PageMethods.GetData(patente, ($find("<%=GridVehiculos.ClientID %>").get_pageSize() * $find("<%=GridVehiculos.ClientID %>").get_currentPageIndex()), $find("<%=GridVehiculos.ClientID %>").get_pageSize(), FillGrid, Error);
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" Skin="Sunset" VisibleTitlebar="true"
        ...
        <Windows>
            ...
            <telerik:RadWindow ID="RadWindow2" runat="server" Behaviors="Close" Width="750" Height="440"
                                    ...
                                    <table style="background-color: transparent; font-family: Sans-Serif; font-size: 11px;
                                        ...
                                        <tr>
                                            ...
                                            <td valign="middle" align="left" width="310px">
                                                <telerik:RadTextBox ID="txtNroPatente" runat="server" EmptyMessage="Ingrese el Dominio"
                    ...
                    <tr>
                        <td align="center">
                            <cc1:ClientControlGrid ID="GridVehiculos" runat="server" AllowMultiSelection="false"
                                TypeSkin="Sunset" PositionAdd="Top" AllowRowSelection="true" Width="100%" KeyName="IdVehiculoEquipo"
                                AllowPaging="false" PageSize="8" EmptyMessage="No hay resultados">
                                <FunctionsGral>
                                ...
                                <Columns>
                                    ...
                                    <cc1:Column CssClass="tdSimple" HeaderName="Nro Interno" DataFieldName="NroInterno"
                                        Align="Centrado" NameControlManger="txtNroInterno" ExportToExcel="true" />
                                    ...
                                    <cc1:Column HeaderName="VencimientoCredencial" DataFieldName="VencimientoCredencial"
                                        Display="false" NameControlManger="txtFechaVenCredencial" ExportToExcel="true" />
            ...
            <cc1:ServerControlWindow ID="ServerControlWindow1" runat="server" BackColor="WhiteSmoke"
                ...
                <ContentControls>
                    <cc1:ServerPanel runat="server" ID="pnlEdicion">
                        <BodyContent>
                            <div id="divPrincipal" style="height: 790px; width: 900px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 5px; padding-right: 5px">
                                            <telerik:RadDatePicker ID="txtFechaFabricación" MinDate="1950/1/1" runat="server"
                                                ZIndex="922000000">
                                                <DateInput DateFormat="yyyy" runat="server" DisplayDateFormat="yyyy">
                                                </DateInput>
                                        ...
                                        <td colspan="4" align="left" style="padding-left: 5px; padding-right: 5px">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: left;">
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <telerik:RadDatePicker ID="txtFechaHabilitacionEE" MinDate="1950/1/1" runat="server"
                                                            ZIndex="922000000">
                                                        </telerik:RadDatePicker>
                                                    </td>
                                                </tr>
                                        ...
                                        <td style="padding-left: 5px; padding-right: 5px;">
                                            <div style="padding-bottom: 3px">
                                                <telerik:RadComboBox ID="cboEmpresa" runat="server" Skin="Sunset" Width="100%" EmptyMessage="Seleccione Empresa"
                                                    ...
                                                    OnClientSelectedIndexChanged="CargarContratosySeguros">
                                                </telerik:RadComboBox>
                                            </div>
